...
<div class="row">
  <div class="col-lg-4 col-md-8 col-12 mx-auto">
    ...
    @endif
      <div class="card-body">
        <form role="form" class="text-start" method="POST" action="{{ route('roles.update', $role->id) }}">
             @method('patch')
             @csrf
          ...
          <div class="form-check form-switch d-flex align-items-center mb-3">
            ...
            <input class="form-check-input" type="checkbox" name="permission[]" id="permission[{{$value->id}}]" value="{{ $value->id }}" {{ in_array($value->id, $rolePermissions) ? 'checked' : '' }}>
